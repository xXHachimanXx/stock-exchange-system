...
func TestBuyAsset(t *testing.T) {
	...
	assert.Equal(5, investorAssetPosition.NumShares, "Investor 1 should have 5 shares of asset 1")
	assert.Equal(5, investor2.getInvestorAssetPosition("asset1").NumShares, "Investor 2 should have 5 shares of asset 1")
}
...
func TestBuyAssetWithDifferentAssents(t *testing.T) {
	...
	investor2.AddInvestorAssetPosition(investorAssetPosition2)
...
func TestBuyPartialAsset(t *testing.T) {
	...
	investor3.AddInvestorAssetPosition(investorAssetPosition2)
	...
	assert.Equal(0, investorAssetPosition.NumShares, "Investor 1 should have 0 shares of asset 1")
	assert.Equal(3, investor2.getInvestorAssetPosition("asset1").NumShares, "Investor 2 should have 3 shares of asset 1")
